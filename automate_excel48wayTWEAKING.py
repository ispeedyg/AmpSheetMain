...
path = "/Users/speedy/Documents/WaldenMedia/Sept2023/Sheet48wayUpstage1.xlsx"
wb = openpyxl.load_workbook(path)
sheet = wb['Racks']
wk = xw.books.open(r"/Users/speedy/Documents/WaldenMedia/Sept2023/Sheet48wayUpstage1.xlsx")  # might not work in
# vsCode not sure what the r is
...
for x in range(15, 21, 1):
    ...
    for c in range(5):
        ...
        for e in range(rowCount - 2):
            ...
            secChanLow = int(secChanLow)
            secChanHi = int(secChanHi)
...
for aa in range(53, 59, 1):
    for bb in range(4, 9, 1):
        ...
        print(f"Fifth Soca Channel nums: {fifthSection}")
    ...
    for cc in range(5):
        ...
        for ee in range(rowCount - 2):
            ...
            if dd in range(fifthChanLow, fifthChanHi):
                ...
                print(f"FifthSoca chan: {dd} watts = {fifthWatts}")
